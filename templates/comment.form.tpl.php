...
<form method="post" action="?q=<?php echo $action_url ?>" enctype="multipart/form-data">
	<input id="obj_foreign_table" name="obj[foreign_table]" type="hidden" value="<?php echo plain($obj_values['foreign_table']) ?>">
	<input id="obj_foreign_id"    name="obj[foreign_id]"    type="hidden" value="<?php echo plain($obj_values['foreign_id']) ?>">
	...
	<div id="obj_content_container">
		<textarea id="obj_content" name="obj[content]" class="textarea"><?php echo $obj_values['content'] ?></textarea>
	</div>
