...
<form method="post" action="?q=<?php echo $action_url ?>" enctype="multipart/form-data">
	<input id="obj_foreign_table" name="foreign_table" type="hidden" value="<?php echo plain($values['foreign_table']) ?>">
	<input id="obj_foreign_id"    name="foreign_id"    type="hidden" value="<?php echo plain($values['foreign_id']) ?>">
	...
	<div id="obj_content_container">
		<textarea id="obj_content" name="content" class="textarea"><?php echo $values['content'] ?></textarea>
	</div>
