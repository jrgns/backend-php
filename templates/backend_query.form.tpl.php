...
?>
		<form method="post" action="?q=<?php echo $action_url ?>" enctype="multipart/form-data">
			<div id="obj_alias_container">
				...
				<input id="obj_alias" name="obj[alias]" type="text" class="text" value="<?php echo plain($values['alias']) ?>">
			</div>
			<div id="obj_query_container">
				<label id="obj_query_label" for="obj_query">Query</label><br>
				<input id="obj_query" name="obj[query]" type="text" class="text" value="<?php echo plain($values['query']) ?>">
			</div>
