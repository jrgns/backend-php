...
<form method="post" action="?q=<?php echo $action_url ?>" enctype="multipart/form-data">
	<div id="value_name_container">
		<label id="value_name_label">Name<br>
			<input id="value_name" name="name" type="text" class="text" value="<?php echo plain($values['name']) ?>">
		</label>
	</div>
	<div id="value_surname_container">
		<label id="value_surname_label">Surname<br>
			<input id="value_surname" name="surname" type="text" class="text" value="<?php echo plain($values['surname']) ?>">
		</label>
	</div>
	<div id="value_email_container">
		<label id="value_email_label">Email<br>
			<input id="value_email" name="email" type="text" class="text" value="<?php echo plain($values['email']) ?>">
		</label>
	</div>
	<div id="value_website_container">
		<label id="value_website_label">Website<br>
			<input id="value_website" name="website" type="text" class="text" value="<?php echo plain($values['website']) ?>">
		</label>
	</div>
	<div id="value_mobile_container">
		<label id="value_mobile_label">Mobile<br>
			<input id="value_mobile" name="mobile" type="text" class="text" value="<?php echo plain($values['mobile']) ?>">
		</label>
	</div>
	<div id="value_username_container">
		<label id="value_username_label">Username<br>
			<input id="value_username" name="username" type="text" class="text" value="<?php echo plain($values['username']) ?>">
		</label>
	</div>
	<?php if (Permission::check('manage', 'BackendUser')): ?>
		<div id="value_confirmed_container">
			<label id="value_confirmed_label">Confirmed<br>
				...
				<option value="0"<?php if (!is_null($values['confirmed']) && empty($values['confirmed'])): ?> selected="selected"<?php endif; ?>>No</option>
				<option value="1"<?php if ($values['confirmed']): ?> selected="selected"<?php endif; ?>>Yes</option>
			</select>
			</label>
		</div>
		<div id="value_active_container">
			<label id="value_active_label">Active<br>
				...
				<option value="0"<?php if (!is_null($values['active']) && empty($values['active'])): ?> selected="selected"<?php endif; ?>>No</option>
