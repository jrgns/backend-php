...
?>
		<form method="post" action="?q=<?php echo $action_url ?>" enctype="multipart/form-data">
			<div id="obj_foreign_table_container">
				...
				<input id="obj_foreign_table" name="obj[foreign_table]" type="text" class="text" value="<?php echo plain($values['foreign_table']) ?>">
			</div>
			<div id="obj_name_container">
				<label id="obj_name_label" for="obj_name">Name</label><br>
				<input id="obj_name" name="obj[name]" type="text" class="text title" value="<?php echo plain($values['name']) ?>">
			</div>
			<div id="obj_description_container">
				<label id="obj_description_label" for="obj_description">Description</label><br>
				<textarea id="obj_description" name="obj[description]" class="textarea"><?php echo $values['description'] ?></textarea>
			</div>
			...
			<div id="obj_weight_container">
				...
				<input id="obj_weight" name="obj[weight]" type="text" class="text" value="<?php echo plain($values['weight']) ?>">
			</div>
